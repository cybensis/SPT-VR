...
namespace TarkovVR
{
    ...
    public static class ScopeManager
    {
        ...
        static ScopeManager()
        {
            ...
            AddScope("parent/scope_all_monstrum_compact_prism_scope_2x32(Clone)", 2, 11);
            ...
            AddScope("scope_all_leupold_mark4_hamr(Clone) parent/scope_all_sig_bravo4_4x30(Clone)", 4f, 6);
